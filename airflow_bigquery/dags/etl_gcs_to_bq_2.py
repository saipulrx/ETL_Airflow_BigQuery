...
year = '2024'
month = '02'
dataset_file = f"green_tripdata_{year}-{month}.parquet"
dataset_transform_file = f"green_tripdata_{year}-{month}_transform.parquet"
...
def transform_data():
    ...
    filter_df = df.query('VendorID == 2 & payment_type == 2')
...
with DAG(
    dag_id="etl_local_to_gcs_to_bigquery_2",
    ...
    load_transform_data_to_bigquery = GCSToBigQueryOperator(
        ...
        destination_project_dataset_table = PROJECT_ID + ".demo_etl.green_trip_data_2024_02"
        )
